...
public class TpBulletin {
		...
		public static void main(String[] args) 
			...
			while(!nom.isEmpty()) 
				...
				{
					String prenom = saisirString("Entrez vtre prénom");
					String statu = saisirString("Entrez vtre statut");
					int nbHeures = saisirInt("Entrez vore nombre d'heures");
					int nbEnfants = saisirInt("Entrez votre nombre d'enfants");
					float tauxH = saisirFloat("Entrez votre taux horaire");
		...
		private static float claculersalaireBrut(int nbHeures, float tauxH)
		{
		...
		private static float claculerCotisations(float salaireBrut)
		{
